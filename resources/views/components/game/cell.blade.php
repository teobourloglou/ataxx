...
<div class="cursor-pointer hover:scale-105 transition-transform duration-300 p-1.5 bg-opacity-25 border-2 border-yellow-800 aspect-square rounded-2xl grow shadow-l shadow-yellow-900 ring-1 ring-yellow-600 {{ in_array([$y, $x], $this->projectionBlocks, true) ? 'bg-white' : 'bg-black' }}">
    @if($value == 1)
